...
La variable Nutrientes $x_{1}$ tiene un coeficiente de $2.0990$ y un $p-valor =2e-16$, por lo tanto no es significativo.

La variable Agua $x_{2}$ tiene un coeficiente de $4.1656$ y un $p-valor =4.51e-06$, por lo tanto no significativo.
...
cat("La utilidad de los pollos es:", utl, "\n")
```
